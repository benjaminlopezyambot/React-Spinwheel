  ...
  return (
    <Transition show={open} as={Fragment}>
      <Dialog
        ...
        className="fixed z-10 inset-0 overflow-y-auto  bg-indigo-900"
      >
                  ...
                  {result.value > 0 ? (
                    <>
                      <h2
                        ...
                        className=" font-bold  mb-7 font-sans text-yellow-400 antialiased"
                      >
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-lime-400 to-yellow-400">
                          You won!
                        </span>
                      </h2>
                      <p className="text-9xl font-bold mb-7 font-sans text-yellow-400 antialiased">
                        {result.option}
                      </p>
                    </>
                  ) : (
                    <>
                      ...
                      <p className="text-6xl font-bold mb-7 font-sans text-red-500 antialiased">
                        {result.option}
                      </p>
                    </>
                  )}
